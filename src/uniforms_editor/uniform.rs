...
impl Uniform {
    ...
    pub fn view(&self) -> Element<Message> {
        ...
        let value_view = match &self.value {
            Type::Int(value) => {
                number_input(value, -100..100, |v| Message::ChangeValue(Type::Int(v))).into()
            }
            Type::Float(value) => number_input(value, -100.0..100.0, |v| {
                Message::ChangeValue(Type::Float(v))
            })
            .into(),
            Type::VecFloat2(value) => Self::number_input2(value, -100.0..100.0, |v| {
                Message::ChangeValue(Type::VecFloat2(v))
            }),
            Type::VecFloat3(value) => Self::number_input3(value, -100.0..100.0, |v| {
                Message::ChangeValue(Type::VecFloat3(v))
            }),
            Type::Col3(value) => {
                Self::number_input3(value, 0.0..1.0, |v| Message::ChangeValue(Type::Col3(v)))
            }
            Type::VecFloat4(value) => Self::number_input4(value, -100.0..100.0, |v| {
                Message::ChangeValue(Type::VecFloat4(v))
            }),
            Type::Col4(value) => {
                Self::number_input4(value, 0.0..1.0, |v| Message::ChangeValue(Type::Col4(v)))
            }
            Type::VecInt2(value) => {
                Self::number_input2(value, -100..100, |v| Message::ChangeValue(Type::VecInt2(v)))
            }
            Type::VecInt3(value) => {
                Self::number_input3(value, -100..100, |v| Message::ChangeValue(Type::VecInt3(v)))
            }
            Type::VecInt4(value) => {
                Self::number_input4(value, -100..100, |v| Message::ChangeValue(Type::VecInt4(v)))
            }
        };
    ...
    {
        row![
            number_input(v0, bounds.clone(), move |v| on_change((v, *v1))),
            number_input(v1, bounds, move |v| on_change((*v0, v))),
        ]
        .into()
    }
            ...
            + Bounded,
    {
        row![
            ...
            number_input(v2, bounds, move |v| on_change((v0.clone(), v1.clone(), v))),
        ]
        .into()
    }
...
impl Candidate {
    ...
    pub fn view(&self) -> Element<CandidateMessage> {
        ...
        let lower_left = row![];
        column![upper_left, lower_left].height(Length::Shrink).into()
    }
